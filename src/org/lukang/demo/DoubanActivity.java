                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    switch (v.getId()) {
                                                        case R.id.btn_douban_oauth:
                                                            dbOAuth
                                                                .lauchforVerifyCode(DoubanActivity.this);
                                                            break;
                                                        case R.id.btn_douban_user:
                                                            fetchUserInfo(uidEdt.getText()
                                                                .toString());
                                                            break;
                                                        case R.id.btn_user_contact:
                                                            fetchUserContacts(uidEdt.getText()
                                                                .toString());
                                                            break;
                                                        case R.id.btn_fetch_book:
                                                            fetchBookInfo(isbnEdt.getText()
                                                                .toString());
                                                            break;
                                                        case R.id.btn_book_comm:
                                                            fetchBookComments(isbnEdt.getText()
                                                                .toString());
                                                            break;
                                                        case R.id.btn_book_collect:
                                                            fetchBookCollection(uidEdt.getText()
                                                                .toString());
                                                            break;
            ...
            switch (type) {
                ...
                case HttpListener.FETCH_BOOK_INFO: // 获取到书籍信息
                    if (pd != null)
                        pd.dismiss();
                    if (data == null) {
                        Toast.makeText(DoubanActivity.this, "book not found", Toast.LENGTH_SHORT)
                            .show();
                        break;
                    }
                ...
                case HttpListener.FETCH_USER_INFO: // 获取用户信息
                    ...
                    if (user.parse4User(String.valueOf(data)))
                        ...
                        Toast.makeText(DoubanActivity.this, "error: user not found!",
                ...
                case HttpListener.FETCH_BOOK_COMMENTS: //获取书籍评论
                    ...
                    if (data == null) {
                        Toast.makeText(DoubanActivity.this, "error: book not found !",
                            Toast.LENGTH_SHORT).show();
                        break;
                    }
                ...
                case HttpListener.SEARCH_BOOKS:
                    ...
                    try {
                        ...
                        bookInfoTv.append("count: " + json.getString("count") + "\t\t total: "
                    ...
                    ArrayList<DoubanBook> list = DoubanBookUtils.parseSearchBooks(String
                        .valueOf(data));
                    if (pd != null)
                        pd.dismiss();
